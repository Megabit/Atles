    ...
    public static class EditContextFluentValidationExtensions
    {
...

        {
            ...
            editContext.OnValidationRequested +=
                (sender, eventArgs) => ValidateModel((EditContext)sender, messages, serviceProvider, fluentValidationValidator, validator);
                                                ...
                                                IValidator validator = null)
        {
            ...
            if (validator is object)
            {
                ...
                foreach (var validationResult in validationResults.Errors)
                {
                    ...
                    var fieldIdentifier = new FieldIdentifier(editContext.Model, validationResult.PropertyName);
